...
5. Potencial de crescimento da região`;
        ...
        const response = await fetch(
          "http://127.0.0.1:7860/api/v1/run/7c297f4c-1b7e-4e29-9649-033ab1187d48?stream=false",
          {
            method: "POST",
            headers: {
              "Content-Type": "application/json",
              "x-api-key": "sk-5rTQXjyfsM4HctQ7PWbk95TO_2m7uWNag31FF-dW_YU"
            },
            body: JSON.stringify({
              input_value: prompt,
              output_type: "chat",
              ...
              tweaks: {
                "Agent-d1Jpj": {},
                "ChatInput-nGMTr": {},
                "PythonFunction-yS5NP": {},
                "PythonFunction-PvGsG": {},
                "PythonFunction-Uhkov": {},
                "NVIDIAEmbeddingsComponent-lJFkd": {},
                "Chroma-zJp7G": {},
                "ChatOutput-sZRUr": {},
                "TextInput-8YLsH": {},
                "Prompt-XcgwU": {},
